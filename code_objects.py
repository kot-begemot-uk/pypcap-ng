...
class AbstractHelper():
    ...
    def get_code(self):
        ...
        if self.pcap_obj is None:
            raise ValueError(f"No pcap_obj with {self.helper_id}, should not occur")

        return self.pcap_obj.get_code(self.helper_id)

    def add_code(self, code):
        '''Add the code generated by this helper'''
        return self.pcap_obj.add_code(code, self.helper_id)
